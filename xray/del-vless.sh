#!/bin/bash
# ==========================================
# DELETE VLESS ACCOUNT (Refactored)
# ==========================================
...
if [[ -s "$tmpfile" ]] && jq empty "$tmpfile" >/dev/null 2>&1; then
    ...
    echo -e "\n${GREEN}✅ User VLESS '${target_user}' berhasil dihapus secara permanen!${NC}\n"
else
