#!/bin/bash
# ==========================================
# RENEW SHADOWSOCKS ACCOUNT (Refactored)
# ==========================================
...
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "\E[44;1;39m          PERPANJANG AKUN SHADOWSOCKS         \E[0m"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"

if [[ ! -s "$DB" ]]; then
    echo -e "\n${RED}❌ Tidak ada user Shadowsocks yang terdaftar!${NC}"
    read -n 1 -s -r -p "Tekan apa saja untuk kembali..."
    m-ssws
    exit 0
fi

echo -e "\n${CYAN}📋 Daftar User Shadowsocks:${NC}\n"
